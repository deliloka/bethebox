public partial class MainView: Fuse.App
{
    ...
    public partial class Factory: Uno.UX.Factory
    {
        ...
        outsideTheBox_FuseDrawingSolidColor_float4_Color_Property color_Color_inst;
        ...
        public override object New()
        {
            ...
            color_Color_inst = new outsideTheBox_FuseDrawingSolidColor_float4_Color_Property(color);
    ...
    outsideTheBox_FuseTriggersWhileBool_bool_Value_Property canSwipe_Value_inst;
    outsideTheBox_FuseiOSStatusBarConfig_UnoPlatformiOSStatusBarStyle_Style_Property statusBarConfig_Style_inst;
    outsideTheBox_FuseEffectsBlur_float_Radius_Property blur_Radius_inst;
    ...
    void InitializeUX()
    {
        ...
        canSwipe_Value_inst = new outsideTheBox_FuseTriggersWhileBool_bool_Value_Property(canSwipe);
        statusBarConfig = new Fuse.iOS.StatusBarConfig();
        statusBarConfig_Style_inst = new outsideTheBox_FuseiOSStatusBarConfig_UnoPlatformiOSStatusBarStyle_Style_Property(statusBarConfig);
        blur = new Fuse.Effects.Blur();
        blur_Radius_inst = new outsideTheBox_FuseEffectsBlur_float_Radius_Property(blur);
