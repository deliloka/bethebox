...
public class XliCppThreadHandler extends Handler {
	...
	private void handleRepeating(Message msg)
	{
		if (msg.arg1 == xliCallbackIndex) {
            com.outsideTheBox.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1); // {TODO} this should own callback
			...
			com.outsideTheBox.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1);
