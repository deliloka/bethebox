...
public class ExternedBlockHost
{
    public static void SetNavigationBarVisible_0(final Object _this, boolean visible)
    {
        ...
        {
        	android.view.View decorView = com.outsideTheBox.outsideTheBox.GetRootActivity().getWindow().getDecorView();
    ...
    {
        android.view.Window window = com.outsideTheBox.outsideTheBox.GetRootActivity().getWindow();
