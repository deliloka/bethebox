...
::g::Outracks::Simulator::Application_type* GeneratedApplication_typeof()
{
    ...
    ::STRINGS[1] = uString::Const("160.67.2.73");
    ::STRINGS[2] = uString::Const("/Users/n07101/dev/fuseProjects/outsideTheBox/outsideTheBox.unoproj");
