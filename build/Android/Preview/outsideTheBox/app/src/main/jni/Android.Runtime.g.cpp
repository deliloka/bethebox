...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(843)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(883)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(923)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(1123)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(1084)
// --------------------------------------------------------
...
// public float get_Item(int i) [instance] :1094
float FloatArray::Item(int i)
{
    uStackFrame __("Android.Runtime.FloatArray", "get_Item(int)");
    return ::g::Android::Base::JNI::GetFloatArrayElement((uObject*)this, i);
}

// public void set_Item(int i, float value) [instance] :1098
void FloatArray::Item(int i, float value)
{
    uStackFrame __("Android.Runtime.FloatArray", "set_Item(int,float)");
    ::g::Android::Base::JNI::SetFloatArrayElement((uObject*)this, i, value);
}

// public float[] ToUnoArray() [instance] :1109
uArray* FloatArray::ToUnoArray()
{
    uStackFrame __("Android.Runtime.FloatArray", "ToUnoArray()");
    return ::g::Android::Base::Types::Arrays::JavaToUnoFloatArray(_javaObject);
}

// public FloatArray New(int length) [static] :1087
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(1005)
// --------------------------------------------------------
...
// public IntArray(int length) :1009
...
// public int get_Item(int i) :1016
void IntArray__get_Item_fn(IntArray* __this, int* i, int* __retval)
{
    *__retval = __this->Item(*i);
}

// public void set_Item(int i, int value) :1020
void IntArray__set_Item_fn(IntArray* __this, int* i, int* value)
{
    __this->Item(*i, *value);
}

// public IntArray New(int length) :1009
void IntArray__New6_fn(int* length, IntArray** __retval)
{
    *__retval = IntArray::New6(*length);
}

// public IntArray(int length) [instance] :1009
void IntArray::ctor_6(int length)
{
    uStackFrame __("Android.Runtime.IntArray", ".ctor(int)");
    ctor_4(::g::Android::Base::JNI::GetDefaultObject(), ::g::Android::Base::JNI::GetDefaultType(), false, false);
...
// public int get_Item(int i) [instance] :1016
int IntArray::Item(int i)
{
    uStackFrame __("Android.Runtime.IntArray", "get_Item(int)");
    return ::g::Android::Base::JNI::GetIntArrayElement((uObject*)this, i);
}

// public void set_Item(int i, int value) [instance] :1020
void IntArray::Item(int i, int value)
{
    uStackFrame __("Android.Runtime.IntArray", "set_Item(int,int)");
    ::g::Android::Base::JNI::SetIntArrayElement((uObject*)this, i, value);
}

// public IntArray New(int length) [static] :1009
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(758)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(755)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(707)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(798)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(1045)
// --------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(637)
// -------------------------------------------------------
...
void NativeActivityHelper::Init()
{
    ...
    jclass cls = ::g::Android::Base::JNI::LoadClass(jni, "com.outsideTheBox.outsideTheBox");
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(1176)
// --------------------------------------------------------
...
// public ObjectArray(Android.Base.Primitives.ujobject obj, Uno.Type typePtr, bool typeHasFallbackClass, bool resolveType) :1182
void ObjectArray__ctor_5_fn(ObjectArray* __this, jobject* obj, uType* typePtr, bool* typeHasFallbackClass, bool* resolveType)
{
    __this->ctor_5(*obj, typePtr, *typeHasFallbackClass, *resolveType);
}

// public ObjectArray(int length) :1178
...
// public ObjectArray New(int length) :1178
void ObjectArray__New6_fn(uType* __type, int* length, ObjectArray** __retval)
{
    *__retval = ObjectArray::New6(__type, *length);
}

// public ObjectArray(Android.Base.Primitives.ujobject obj, Uno.Type typePtr, bool typeHasFallbackClass, bool resolveType) [instance] :1182
void ObjectArray::ctor_5(jobject obj, uType* typePtr, bool typeHasFallbackClass, bool resolveType)
{
    uStackFrame __("Android.Runtime.ObjectArray`1", ".ctor(Android.Base.Primitives.ujobject,Uno.Type,bool,bool)");
    ctor_4(obj, typePtr, typeHasFallbackClass, false);
}

// public ObjectArray(int length) [instance] :1178
void ObjectArray::ctor_6(int length)
{
    uType* __types[] = {
        __type->T(0),
    };
    uStackFrame __("Android.Runtime.ObjectArray`1", ".ctor(int)");
    ctor_5(::g::Android::Runtime::ObjectArrayAUX::makeArrayJObject(::g::Uno::String::Replace1(uPtr(::g::Uno::String::Substring(uPtr(uPtr(__types[0])->ToString()), 8)), ::STRINGS[2/*"."*/], ::STRINGS[3/*"/"*/]), length), __type, false, false);
}
...
// public ObjectArray New(int length) [static] :1178
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(1169)
// --------------------------------------------------------
...
// internal static extern Android.Base.Primitives.ujobject makeArrayJObject(string typeName, int length) :1172
...
// internal static extern Android.Base.Primitives.ujobject makeArrayJObject(string typeName, int length) [static] :1172
jobject ObjectArrayAUX::makeArrayJObject(uString* typeName_, int length_)
{
    uStackFrame __("Android.Runtime.ObjectArrayAUX", "makeArrayJObject(string,int)");
    INIT_JNI;
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(58)
// ------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(964)
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Android/0.23.1/$.uno(14)
// ------------------------------------------------------
...
{
    uStackFrame __("Android.Runtime.UnoHelper", "MakeJSObservable(Android.java.util.Observer)");
    INIT_JNI;
