...
// public sealed class ByteFileSource :122
// {
...
// public override sealed byte[] ReadAllBytes() :141
...
// public void Update(byte[] newBytes) :125
void ByteFileSource__Update_fn(ByteFileSource* __this, uArray* newBytes)
{
    __this->Update(newBytes);
}

// public ByteFileSource(string path, byte[] bytes) [instance] :132
...
// public ByteFileSource New(string path, byte[] bytes) [static] :132
