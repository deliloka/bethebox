...
// public UxTemplate(Uno.Func<object, object> matches, Uno.Func<object, object> applyMethod) [instance] :95
void UxTemplate::ctor_(uDelegate* matches, uDelegate* applyMethod)
{
    uStackFrame __("Outracks.Simulator.Runtime.UxTemplate", ".ctor(Uno.Func<object, object>,Uno.Func<object, object>)");
    _matches = matches;
    _apply = applyMethod;
}

// public bool Apply(object obj) [instance] :102
bool UxTemplate::Apply(uObject* obj)
{
    uStackFrame __("Outracks.Simulator.Runtime.UxTemplate", "Apply(object)");
...
// public UxTemplate New(Uno.Func<object, object> matches, Uno.Func<object, object> applyMethod) [static] :95
