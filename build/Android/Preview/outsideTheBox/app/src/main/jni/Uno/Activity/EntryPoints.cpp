...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/outsideTheBox/outsideTheBox");
    jclass entryPointsClass = env->FindClass("com/outsideTheBox/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/outsideTheBox/Display");
