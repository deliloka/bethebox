...
struct outsideTheBox_FuseElementsElement_float_Opacity_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Elements::Element*> _obj;

    void ctor_1(::g::Fuse::Elements::Element* obj);
    static outsideTheBox_FuseElementsElement_float_Opacity_Property* New1(::g::Fuse::Elements::Element* obj);
};
// }
