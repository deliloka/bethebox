...
struct outsideTheBox_FuseTranslation_float_X_Property : ::g::Uno::UX::Property
{
    uStrong< ::g::Fuse::Translation*> _obj;

    void ctor_1(::g::Fuse::Translation* obj);
    static outsideTheBox_FuseTranslation_float_X_Property* New1(::g::Fuse::Translation* obj);
};
// }
